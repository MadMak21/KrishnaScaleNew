    ...
    <>
      <header className="absolute top-0 left-0 right-0 z-40 flex items-center px-6 md:px-10 py-5 bg-transparent overflow-visible">
        ...
        <div className="hidden md:flex w-1/4 justify-end items-center gap-2 z-50">
          <button onClick={() => i18n.changeLanguage('en')} className={`text-[10px] font-bold tracking-widest transition-colors cursor-pointer px-2 py-1 rounded ${i18n.language === 'en' ? 'bg-orange-500 text-white' : 'text-gray-400 hover:text-white'}`}>English</button>
