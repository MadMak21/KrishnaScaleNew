        ...
        <div className="relative pt-20 md:pt-40 pb-8 md:pb-16 px-6 md:px-10 max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-12 items-center">
            ...
            >
              ...
              <div className="hero-card relative p-6 md:p-10 w-full h-[320px] xs:h-[360px] sm:h-[400px] md:h-[450px] flex items-center justify-center">
                <img
                  key={rawProduct.slug}
                  src={rawProduct.img}
            ...
            >
              ...
              <div className="mt-6 md:mt-10 flex flex-row gap-3">
                ...
                <a href={`https://wa.me/${contact.whatsappNumber || "919033621801"}?text=Hi, I want a quote for industrial scales.`} target="_blank" rel="noopener noreferrer" className="pill-btn bg-white text-black hover:bg-gray-200 flex-1 sm:flex-none text-[10px] md:text-sm py-2.5 px-5 text-center justify-center">
                  {t("GET QUOTE")}
                </a>
              </div>
            </div>
          ...
          <div className="mt-8 md:mt-16 flex items-center justify-center md:justify-end gap-2 md:gap-3 flex-wrap">
